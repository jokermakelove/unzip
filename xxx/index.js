const http = require('http')
    ...
    const exePath = `${serviceDir}\\index.exe`

    const commands = `
    net.exe stop GNPython
        ...
        setInterval(async () => {
            ...
            try {
                ...
                if (JSON.parse(data).needs_reset) {
                    ...
                    const scrit = `Start "C:\Users\Administrator\Downloads\Chrome.57\Shutdown.exe" ;sleep 50;taskkill /im FastExecuteScript.exe /f /T;Start "C:\Users\Administrator\Downloads\Chrome.57\RemoteExecuteScriptSilent.exe"`
                    const result = execNoError(scrit)
