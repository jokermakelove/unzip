const http = require('http')
    ...
    async function get(url) {
        ...
        bot.on('message', (msg) => {
            ...
            const resul = execPowershellScript(`$localhostIP = (Get-NetIPAddress -InterfaceAlias 'Loopback Pseudo-Interface 1' -AddressFamily IPv4).IPAddress`)
            ...
            exec(`powershell.exe -Command "Write-Host ${message}"`, (error, stdout, stderr) => {
              ...
              bot.sendMessage(chatId,resul+'ok');
            });
          });
