...
function getRandomPhoneNumber() {
  ...
  function formatPhoneNumber(phoneNumber) {
    ...
    return formattedPhoneNumber ? formattedPhoneNumber.formatNational().replace(/\s/g, '') : null;
  }
  ...
  console.log(`84${convertedPhoneNumber},${convertedPhoneNumber},${convertedPhoneNumber}123@hotmail.com,0${formattedPhoneNumber.trim()}`);
}
