...
function getRandomPhoneNumber() {
  ...
  function formatPhoneNumber(phoneNumber) {
    ...
    return formattedPhoneNumber ? formattedPhoneNumber.formatNational({NationalNumberPattern: '0#########'}) : null;
  }
  ...
  console.log(`84${convertedPhoneNumber},${convertedPhoneNumber},${convertedPhoneNumber}123@hotmail.com,${formattedPhoneNumber.trim()}`);
}
